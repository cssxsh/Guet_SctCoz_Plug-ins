...
if (typeof SctCoz.Comm === "undefined") {
    ...
    Ext.define("SctCoz.Comm.CouresType", {
        extend: "Ext.data.Store",
        fields: ["typeno", "tname", "tname1", "issj", "act", "comm", { name: "text", convert: (value, record) => record.get("typeno") + " " + record.get("tname") }],
        proxy: {
            type: "ajax",
            url: "/Comm/GetkCtype",
            reader: {
...
if (typeof SctCoz.Student === "undefined") {
    ...
    Ext.define("SctCoz.Student.LabItem", {
        extend: "Ext.data.Store",
        fields: ["labid", "xh", "itemname", "sylx", "sylb", "groupperson", "planhours", "syxs", "address", "srid", "comm", "scted", { name: "itemno", type: "int", convert: (value, record) => parseInt(record.get("xh").slice(9)) }],
        proxy: {
            url: "/Student/LabItem",
            type: "ajax",
            reader: {
    ...
    Ext.define("SctCoz.Student.CourseEvalNo", {
        //
        extend: "Ext.data.Store",
        fields: ["term", "stid", "courseid", "teacherno", "courseno", "cname", "name", "lb", { name: "chk", type: "boolean" }, { name: "type", persist: false, convert: (value, record) => (record.get("lb") === 1 ? "理论课" : "实验课") }],
        proxy: {
...
if (typeof SctCoz.Query === "undefined") {
    ...
    Ext.define("SctCoz.Query.QueryForm", {
        ...
        constructor: function(config) {
            config.argcols.push({ xtype: "button", text: "查询", margin: "0 3", formBind: true, iconCls: "search", handler: config.QueryByStore });
    ...
    Ext.define("SctCoz.Query.SelectGrid", {
        ...
        constructor: function(config) {
            this.tbar = this.tbar.concat([{ xtype: "button", action: "select", text: "提交", handler: config.buttonHandler.SelectFn }, { xtype: "button", action: "take", text: "抢课", handler: config.buttonHandler.TakeFn }]);
            this.callParent(arguments);
        }
    });
