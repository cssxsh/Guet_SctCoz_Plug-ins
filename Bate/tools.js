...
defineByExt = () => {
    ...
    Ext.define('SctCoz.Comm.Store.CollegeInfo', {
        ...
        fields: [
            ...
            {
                name: 'text',
                convert: (value, record) => record.get('dptno') + ' ' + record.get('dptname'),
            },
            {
                name: 'CollegeNo',
    ...
    Ext.define('SctCoz.Comm.Store.MajorInfo', {
        ...
        fields: [
            ...
            {
                name: 'text',
                convert: (value, record) => record.get('spno') + ' ' + record.get('spname'),
            },
    ...
    Ext.define('SctCoz.Comm.Store.CourseType', {
        ...
        fields: [
            ...
            {
                name: 'text',
                convert: (value, record) => record.get('typeno') + ' ' + record.get('tname'),
            },
        ],
        proxy: {
            type: 'ajax',
    ...
    Ext.define('SctCoz.Student.Store.CourseEvalNo', {
        ...
        fields: [
            ...
            { name: 'chk', type: 'boolean' },
            {
                name: 'type',
                persist: false,
                convert: (value, record) => (record.get('lb') === 1 ? '理论课' : '实验课'),
            },
        ],
        proxy: {
